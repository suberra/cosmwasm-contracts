    ...
    T: Clone + fmt::Debug + PartialEq + JsonSchema,
{
    ...
    /// Freeze will make a mutable contract immutable, must be called by the owner
    Freeze {},
    /// Unfreeze will make an immutable contract mutable. Must be called by the owner
    Unfreeze {},
    /// UpdateAdmins will change the admin set of the contract, must be called by the owner
    ...
    T: Clone + fmt::Debug + PartialEq + JsonSchema,
{
    ...
    AdminList {},
    // Returns the owner of the subwalles as a String
    Owner {},
